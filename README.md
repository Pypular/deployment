Pypular Ansible deployment Playbook
===================================

Based and adapted from [ansible-django-stack](https://github.com/jcalazan/ansible-django-stack)


**You must create the roles/web/templates/.env file for it to work. (see env-sample)**
